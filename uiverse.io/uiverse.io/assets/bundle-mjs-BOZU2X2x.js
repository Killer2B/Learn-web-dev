...
function ge() {
    let e = 0,
        r, t, o = "";
    for (; e < arguments.length;)(r = arguments[e++]) && (t = ee(r)) && (o && (o += " "), o += t);
    return o
}
const ee = e => {
    if (typeof e == "string") return e;
    let r, t = "";
    for (let o = 0; o < e.length; o++) e[o] && (r = ee(e[o])) && (t && (t += " "), t += r);
    return t
};
...
const c = e => {
    ...
    xe = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/,
    ...
    C = e => M(e) || he.has(e) || me.test(e),
    z = e => G(e, "length", Ie),
    M = e => !!e && !Number.isNaN(Number(e)),
    _ = e => G(e, "number", M),
    P = e => !!e && Number.isInteger(Number(e)),
    Ce = e => e.endsWith("%") && M(e.slice(0, -1)),
    l = e => re.test(e),
    S = e => ye.test(e),
    ze = new Set(["length", "size", "percentage"]),
    Se = e => G(e, ze, te),
    Ae = e => G(e, "position", te),
    Me = new Set(["image", "url"]),
    Ge = e => G(e, Me, je),
    Re = e => G(e, "", Pe),
    j = () => !0,
    G = (e, r, t) => {
