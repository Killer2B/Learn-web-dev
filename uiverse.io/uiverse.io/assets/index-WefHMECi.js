...
var _ = "rovingFocusGroup.onEntryFocus",
    ...
    [$, be] = z(b, [Z]),
    [ee, oe] = $(b),
    N = s.forwardRef((e, r) => d.jsx(h.Provider, {
...
var te = s.forwardRef((e, r) => {
        const {
            ...
            ...C
        } = e, v = s.useRef(null), I = V(r, v), t = W(g), [l = null, T] = Q({
            prop: R,
            defaultProp: E,
            onChange: m
        }), [u, i] = s.useState(!1), S = J(a), M = G(c), x = s.useRef(!1), [k, y] = s.useState(0);
        return s.useEffect(() => {
            const n = v.current;
            if (n) return n.addEventListener(_, S), () => n.removeEventListener(_, S)
        }, [S]), d.jsx(ee, {
            scope: c,
            orientation: o,
            dir: t,
                ...
                onFocus: p(e.onFocus, n => {
                    ...
                    if (n.target === n.currentTarget && L && !u) {
                        ...
                        if (n.currentTarget.dispatchEvent(P), !P.defaultPrevented) {
                            const A = M().filter(f => f.focusable),
                                U = A.find(f => f.active),
                                B = A.find(f => f.id === l),
    ...
    K = s.forwardRef((e, r) => {
        const {
            ...
            tabStopId: g,
            ...R
        } = e, E = q(), m = g || E, a = oe(O, c), w = a.currentTabStopId === m, C = G(c), {
            onFocusableItemAdd: v,
            onFocusableItemRemove: I
        } = a;
        return s.useEffect(() => {
            if (o) return v(), () => I()
        }, [o, v, I]), d.jsx(h.ItemSlot, {
            scope: c,
            id: m,
            focusable: o,
            active: F,
            children: d.jsx(D.span, {
                tabIndex: w ? 0 : -1,
...
function se(e, r, c) {
    const o = ne(e.key, c);
    if (!(r === "vertical" && ["ArrowLeft", "ArrowRight"].includes(o)) && !(r === "horizontal" && ["ArrowUp", "ArrowDown"].includes(o))) return re[o]
}
