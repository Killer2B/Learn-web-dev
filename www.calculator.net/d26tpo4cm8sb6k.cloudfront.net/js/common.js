    ...
    if (0 < l.length) {
        ...
        if (0 < C)
            if (6 < C) {
                ...
                for (i = 0; i < C; i++) c += n[i];
        else c = 'No calculator matches "' + gObj("calcSearchTerm").value + '".'
    }
    return gObj("calcSearchOut").innerHTML = c, !1
}