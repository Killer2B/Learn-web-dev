...
(function() {
    ...
    function it(e, t) {
        return t = t != null ? t : {}, Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : Ir(Object(t)).forEach(function(a) {
    ...
    function ft(e) {
        return e === void 0 ? !0 : typeof e == "string" && kr.test(e)
    }
    ...
    var St = function(e) {
            var t, a, o = window.innerWidth < 400,
                c = e.state === Ce.FailureFeedback || e.state === Ce.FailureHavingTroubles,
                l, v = L(Mr, (l = (t = e.displayLanguage) === null || t === void 0 ? void 0 : t.toLowerCase()) !== null && l !== void 0 ? l : "nonexistent"),
                h, s = L(Lr, (h = (a = e.displayLanguage) === null || a === void 0 ? void 0 : a.toLowerCase()) !== null && h !== void 0 ? h : "nonexistent");
            return o ? Fr({
    ...
    function br() {
        ...
        var e = !0,
            ...
            a = void 0;
        try {
            for (var o = Vt[Symbol.iterator](), c; !(e = (c = o.next()).done); e = !0) {
                var l = c.value;
                l()
            }
        } catch (v) {
    ...
    function Ur(e) {
        ...
        if (!(t === void 0 || t.hasResponseParamEl)) {
            ...
            if (o) {
                ...
                var v;
                if (typeof t.params["response-field-name"] != "string" && Rr((v = t.params.sitekey) !== null && v !== void 0 ? v : "")) {
    ...
    function Tr(e, t) {
        ...
        if (o !== null && V(o, HTMLInputElement) && (o.value = t), y.isRecaptchaCompatibilityMode) {
    ...
    function Mt(e, t) {
        ...
        switch (l) {
            ...
            case q.Managed:
                switch (c) {
                    case M.Compact:
                        ...
                        break;
                    case M.Invisible:
                        g('Invalid value for parameter "size", expected "'.concat(M.Compact, '" or "').concat(M.Normal, '", got "').concat(c, '"'), 2817);
                    case M.Normal:
            ...
            case q.Invisible:
                ...
                break;
            default:
                g('Invalid value for parameter "mode", expected "'.concat(q.NonInteractive, '", "').concat(q.Managed, '" or "').concat(q.Invisible, '", got "').concat(l, '"'), 2818)
        }
    }
    ...
    var Dt = function() {
        var e = function(n, i, r, u) {
            ...
            a = function(n, i, r) {
                var u;
                n.response === void 0 && g("[Internal Error] Widget was completed but no response was given", 1362), n.isExecuting = !1, n.isComplete = !0, Tr(i, n.response), (u = n.cbSuccess) === null || u === void 0 || u.call(n, n.response, r)
            },
            o = function(n) {
                if (!n) return [];
            ...
            T = function(n, i) {
                ...
                } else V(n, HTMLElement) ? m = n : g('Invalid type for parameter "container", expected "string" or an implementation of "HTMLElement"', 3587);
                var E = !0,
                    S = !1,
                    I = void 0;
                try {
                ...
                if (P) {
                    ...
                    var Se, oe = (Se = f["refresh-timeout"]) !== null && Se !== void 0 ? Se : ce.Auto;
                    ...
                    dt(he) || g('Invalid input for optional parameter "action", got "'.concat(he, '"'), 3604), ft(re) || g('Invalid input for optional parameter "cData", got "'.concat(re, '"'), 3605);
                    var Ae = l(),
                        pe = $(Ae);
                    if (!(!Ae || !pe)) {
                        var Wt = [],
                        ...
                        et || g("Turnstile Initialization Error ", 3606), j.style.display = "none", j.style.border = "none", j.style.overflow = "hidden", j.setAttribute("src", Rt(Ae, H, f, K, !1, "b", z.New, _t(et))), j.onerror = function() {
                            if (Y) {
                        ...
                        var Ut = ["cross-origin-isolated", "fullscreen", "autoplay"],
                            tt;
                        L((tt = (u = document.featurePolicy) === null || u === void 0 || (r = u.features) === null || r === void 0 ? void 0 : r.call(u)) !== null && tt !== void 0 ? tt : [], Et) && Ut.push(Et), j.setAttribute("allow", Ut.join("; ")), j.setAttribute("sandbox", "allow-same-origin allow-scripts allow-popups"), j.id = pe;
                        var rt;
                        j.tabIndex = (rt = f.tabindex) !== null && rt !== void 0 ? rt : 0, j.title = "Widget containing a Cloudflare security challenge", Pt.appendChild(j);
                        var at, Ar = (at = f["response-field"]) !== null && at !== void 0 ? at : !0;
                        if (Ar) {
                            var Me = document.createElement("input");
                            Me.type = "hidden";
                            var nt;
                            if (Me.name = (nt = f["response-field-name"]) !== null && nt !== void 0 ? nt : xt, Me.id = "".concat(pe, "_response"), fe.appendChild(Me), typeof f["response-field-name"] != "string" && Rr(H)) {
                ...
                return Pe(this, function(P) {
                    switch (P.label) {
                        case 0:
                            ...
                            m = "h/".concat("b", "/"), w = new URL(d), E = "https", S = "", D = "".concat(E, "://").concat(w.host, "/cdn-cgi/challenge-platform/").concat(m, "rc/").concat(r).concat(S), P.label = 1;
                        case 1:
                            return P.trys.push([1, 3, , 4]), [4, fetch(D, {
                                method: "POST",
                                headers: {
                        ...
                        case 2:
                            return B = P.sent(), B.status !== 200 ? (x("Cannot determine Turnstile's embedded location, aborting clearance redemption, are you running Turnstile on a Cloudflare Zone?"), a(b, n, !1)) : a(b, n, !0), [3, 4];
                        case 3:
                            return te = P.sent(), x("Error contacting Turnstile, aborting clearance remdeption."), a(b, n, !1), [3, 4];
                        case 4:
                            return [2]
                    }
                })
            ...
            if (n.source === W) {
                ...
                if (!(!n.widgetId || !y.widgetMap.has(n.widgetId))) {
                    ...
                    if (!(!i || !r)) switch (n.event) {
                        case "init":
                            {
                                var u;r.widgetInitStartTimeMs = U();
                                var d = r.shadow.getElementById(i);d || g("Cannot initialize Widget, Element not found (#".concat(i, ")."), 3074),
                                r.mode = n.mode,
                                r.nextRcV = n.nextRcV,
                                r.mode === q.Invisible && r.params["refresh-expired"] === Z.Manual && x("refresh-expired=manual is impossible in invisible mode, consider using '".concat(Z.Auto, "' or '").concat(Z.Never, ".'")),
                                r.mode !== q.Managed && r.params["refresh-timeout"] !== ce.Auto && x("setting refresh-timeout has no effect on an invisible/non-interactive widget and will be ignored."),
                                r.params.appearance === Q.Always || r.isExecuting && r.params.appearance === Q.Execute ? Mt(d, r) : xr(d),
                                d.style.display = "";
                                var m = r.shadow.querySelector("#".concat(i));m || g("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                                (u = m.contentWindow) === null || u === void 0 || u.postMessage({
                                    source: W,
                                    widgetId: n.widgetId,
                                    event: "init"
                                }, "*");
                        ...
                        case "translationInit":
                            {
                                var w = r.shadow.getElementById(i);w || g("Cannot initialize Widget, Element not found (#".concat(i, ")."), 3074);
                                var E = new Map;r.displayLanguage = n.displayLanguage,
                        ...
                        case "languageUnsupported":
                            {
                                x("Language ".concat(r.params.language, " is not supported, falling back to: ").concat(n.fallback, ".")),
                        ...
                        case "overrunBegin":
                            {
                                r.isOverrunning = !0,
                                r.watchcat && (r.watchcat.overrunBeginSeq = r.watchcat.lastAckedSeq);
                                break
                            }
                        case "overrunEnd":
                            {
                        ...
                        case "fail":
                            {
                                n.rcV && c(r, n.rcV, n.widgetId),
                                n.cfChlOut && (r.cfChlOut = n.cfChlOut),
                                n.cfChlOutS && (r.cfChlOutS = n.cfChlOutS),
                                n.code && (r.errorCode = n.code),
                                r.isExecuting = !1,
                                r.isFailed = !0,
                                r.isInitialized = !0,
                                Nt(i);
                                ...
                                if (B) {
                                    var te, P = r.shadow.querySelector("#".concat(i));
                                    P == null || (te = P.contentWindow) === null || te === void 0 || te.postMessage({
                                        source: W,
                                        widgetId: n.widgetId,
                                        event: "forceFail"
                                    }, "*")
                                ...
                                if (D) {
                                    var f;
                                    D(String((f = n.code) !== null && f !== void 0 ? f : Qt)) ? r.params.retry === ve.Auto && !r.isResetting && t(r, i, B) : (n.code && x("Error: ".concat(n.code, ".")), t(r, i, B))
                        ...
                        case "requestFeedbackData":
                            {
                                var re, ke = r.shadow.querySelector("#".concat(i));ke || g("Received state for an unknown widget: #".concat(i, " / ").concat(n.widgetId), 3078),
                                (re = ke.contentWindow) === null || re === void 0 || re.postMessage({
                                    source: W,
                                    widgetId: n.widgetId,
                        ...
                        case "turnstileResults":
                            {
                                var H, ae, se = (H = r.wrapper.parentNode) === null || H === void 0 ? void 0 : H.querySelector("#".concat(i, "-fr"));se || g("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                                (ae = se.contentWindow) === null || ae === void 0 || ae.postMessage({
                                    source: W,
                                    widgetId: n.widgetId,
                                    event: "feedbackData",
                                    rayId: n.rayId,
                        ...
                        case "closeFeedbackReportIframe":
                            {
                                var ne, _e = (ne = r.wrapper.parentNode) === null || ne === void 0 ? void 0 : ne.querySelector("#".concat(i, "-fr"));_e || g("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                                vr("".concat(i, "-fr"));
                                break
                            }
                        case "tokenExpired":
                            {
                                var ie, be = n.token;r.isExpired = !0,
                                (ie = r.cbExpired) === null || ie === void 0 || ie.call(r, be),
                                r.params["refresh-expired"] === Z.Auto && !r.isResetting && _(z.AutoExpire, i);
                                break
                            }
                        ...
                        case "interactiveBegin":
                            {
                                var we, Ne = r.shadow.getElementById(i);Ne || g("Cannot layout widget, Element not found (#".concat(i, ")."), 3076),
                                (we = r.cbBeforeInteractive) === null || we === void 0 || we.call(r),
                                r.params.appearance === Q.InteractionOnly && Mt(Ne, r);
                                break
                            }
                        case "interactiveEnd":
                            {
                                var Ee;
                                (Ee = r.cbAfterInteractive) === null || Ee === void 0 || Ee.call(r);
                                break
                            }
                        case "widgetStale":
                            {
                        ...
                        case "requestExtraParams":
                            {
                                var Te;r.widgetParamsStartTimeMs = U();
                                var Y = r.shadow.querySelector("#".concat(i));Y || g("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                                r.isResetting = !1;
                                var Je = {},
                                    Re = U(),
                                    J = {
                                    ...
                                    Se = U() - Re;
                                (Te = Y.contentWindow) === null || Te === void 0 || Te.postMessage(Ve({
                                    source: W,
                                    widgetId: n.widgetId,
                                    event: "extraParams",
                                    action: r.action,
        ...
        function R(b) {
            ...
            return V(b, Element) ? v(b) : b || y.widgetMap.size === 0 ? null : y.widgetMap.keys().next().value
        }
        var X = {};
        return it(Ve({}, X), {
            ready: function(n) {
            ...
            execute: function(n, i) {
                ...
                if (d) {
                    ...
                    d.isExpired && x("Call to execute on a expired-widget (".concat(m, "), consider using reset() before.")), d.isStale && (_(z.StaleExecute, m), d.isExecuting = !0), d.msgQueue.push(ue.Execute), d.isExecuted = !0;
    ...
    function zr() {
        var e = !0;
        kt(y, e), y.msgHandler && window.removeEventListener("message", y.msgHandler), hr(window.turnstile, y)
    }
    ge = !1, C = pr(), y.scriptWasLoadedAsync = (Ye = C == null ? void 0 : C.loadedAsync) !== null && Ye !== void 0 ? Ye : !1, y.scriptUrl = (Qe = C == null ? void 0 : C.src) !== null && Qe !== void 0 ? Qe : "undefined", C != null && C.params && (ye = C.params.get("compat"), (ye == null ? void 0 : ye.toLowerCase()) === "recaptcha" ? window.grecaptcha ? x("grecaptcha is already defined. The compatibility layer will not be enabled.") : (x("Compatibility layer enabled."), y.isRecaptchaCompatibilityMode = !0, window.grecaptcha = Dt) : ye !== null && x('Unknown value for api.js?compat: "'.concat(ye, '", ignoring.')), C.params.forEach(function(e, t) {
        L(["onload", "compat", "_cb", "_upgrade", "_reload", "render"], t) || x('Unknown parameter passed to api.js: "?'.concat(t, '=...", ignoring.'))
    }), ge = C.params.get("_upgrade") === "true", G = C.params.get("onload"), G && !ge && setTimeout(function() {
