...
var d = o.forwardRef((e, r) => {
    const {
        children: n,
        ...t
    } = e, i = o.Children.toArray(n), s = i.find(v);
    if (s) {
        const l = s.props.children,
            a = i.map(f => f === s ? o.Children.count(l) > 1 ? o.Children.only(null) : o.isValidElement(l) ? l.props.children : null : f);
        return c.jsx(u, { ...t,
            ref: r,
            children: o.isValidElement(l) ? o.cloneElement(l, void 0, a) : null
        })
    }
    return c.jsx(u, { ...t,
        ref: r,
...
var u = o.forwardRef((e, r) => {
    ...
    if (o.isValidElement(n)) {
        const i = C(n);
        return o.cloneElement(n, { ...E(t, n.props),
            ref: r ? p(r, i) : i
        })
    }
...
function E(e, r) {
    ...
    for (const t in r) {
        ...
        /^on[A-Z]/.test(t) ? i && s ? n[t] = (...a) => {
            s(...a), i(...a)
        } : i && (n[t] = i) : t === "style" ? n[t] = { ...i,
            ...s
        } : t === "className" && (n[t] = [i, s].filter(Boolean).join(" "))
    }
    return { ...e,
        ...n
    }
...
var g = ["a", "button", "div", "form", "h2", "h3", "img", "input", "label", "li", "nav", "ol", "p", "span", "svg", "ul"],
    j = g.reduce((e, r) => {
        const n = o.forwardRef((t, i) => {
            ...
            return typeof window < "u" && (window[Symbol.for("radix-ui")] = !0), c.jsx(a, { ...l,
                ref: i
            })
        });
